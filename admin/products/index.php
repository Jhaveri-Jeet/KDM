...
$title = "Products";
$rows = select("SELECT * FROM `Products`");
        ...
        <section class="content">
            <div class="row">
                <div class="col" style="text-align: end">
                    <a role="button" class="btn btn-success" href="<?= urlOf('admin/Products/create.php') ?>">Create New</a>
                </div>
            </div>
            <div class="row">&nbsp;</div>
                        ...
                        <table class="table table-striped item-list">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="item-list-title">Description</th>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($rows); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-name"><?= $rows[$i]['Description'] ?></td>
                                        <td class="item-list-actions">
                                            <div class="btn-group d-none d-lg-flex" role="group" aria-label="Actions">
                                                <a role="button" class="btn btn-primary" href="<?= urlOf("admin/Products/edit.php?id=$id") ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
