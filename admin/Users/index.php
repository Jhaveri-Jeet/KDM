...
$title = "Users";
$rows = select("SELECT `Id`,`Username`, `Password` FROM `Users`");
        ...
        <section class="content">
            <div class="row">
                <div class="col" style="text-align: end">
                    <a role="button" class="btn btn-success" href="<?= urlOf('admin/Users/create.php') ?>">Create New</a>
                </div>
            </div>
            <div class="row">&nbsp;</div>
                        ...
                        <table class="table table-striped item-list">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="item-list-title">Password</th>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($rows); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-name"><?= $rows[$i]['Username'] ?></td>
                                        <td class="item-list-name"><?= $rows[$i]['Password'] ?></td>
                                        <td class="item-list-actions">
                                            <div class="btn-group d-none d-lg-flex" role="group" aria-label="Actions">
                                                <a role="button" class="btn btn-primary" href="<?= urlOf("admin/Users/edit.php?id=$id") ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <a role="button" class="btn btn-danger" onclick="showDeleteUserConfirmation(<?= $rows[$i]['Id'] ?>)" data-toggle="tooltip" data-placement="bottom" title="Delete">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button id="btn-yes" type="button" class="btn btn-danger" onclick="deleteUser()">Yes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
